...
features:
  - title: Shared Notes
    description: Collaborative markdown notes synced across the team
  - title: Matrix Chat
    description: Real-time team communication with knowledge capture
  - title: Meeting Memory
    description: Capture decisions and action items from conversations
  - title: Quick Search
    description: Find any piece of team knowledge in seconds
status: beta
order: 2
---
