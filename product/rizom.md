...
features:
  ...
  - title: Git Sync
    description: Version-controlled knowledge with automatic synchronization
status: live
order: 2
---
...
Every piece of knowledge in Rizom is markdown. Every feature is a plugin. The collective decides which capabilities to enable, and the brain adapts. Need a website? Add the site-builder plugin. Need social media presence? Add the social plugin. The architecture grows with the collective.
